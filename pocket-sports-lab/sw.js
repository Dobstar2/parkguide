const CACHE='pocket-sports-lab-v2';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./data/0.txt','./data/1.txt','./data/2.txt','./data/3.txt','./data/4.txt','./data/5.txt','./data/6.txt'];
